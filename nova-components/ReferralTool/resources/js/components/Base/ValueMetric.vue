<template>
    <loading-card :loading="loading" class="metric px-6 py-4 relative" :class="extraClass">
        <div class="flex mb-4">
        ...
        <p class="flex items-center text-4xl mb-4 metric-value">
            {{ formattedValue }}
            <span v-if="suffix" class="ml-2 text-3xl text-80">{{ formattedSuffix }}</span>
        </p>
