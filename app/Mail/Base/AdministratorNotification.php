...
abstract class AdministratorNotification extends Mailable implements ShouldQueue
{
    ...
    {
        $this->partner = $administrator->partner;
        $this->user = $administrator;
        $this->to($administrator->email, $administrator->name);
    }
