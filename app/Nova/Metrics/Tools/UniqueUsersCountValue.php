...
class UniqueUsersCountValue extends Value
{
    ...
    {
        return __('Number of unique users of BitRewards Tools');
    }
    ...
    public function calculate(NovaRequest $request): ValueResult
    {
        ...
        return $this
            ->result($reportData->numberOfUniqueUsers)
            ->format('0,0');
    }

    public function uriKey(): string
    {
        return 'tools-unique-users-count';
    }
}
