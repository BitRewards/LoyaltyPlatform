...
use App\Http\Middleware\SetLanguageFromPartner;
use App\Nova\Http\Middleware\DefaultPageMiddleware;
...
return [
    ...
    */
    ...
    'middleware' => [
        'web',
        Authenticate::class,
        SetLanguageFromPartner::class,
        DispatchServingNovaEvent::class,
        BootTools::class,
        Authorize::class,
        DefaultPageMiddleware::class,
    ],
];
