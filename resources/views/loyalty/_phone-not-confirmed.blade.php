 ...
 */
?>
<div class="tab-content tab-content_viewtype_centered is-hide js-tab-content" data-id="phone-not-confirmed">
  <div class="tab-content__in">
    <div class="tab-content__header">
      <h2 class="tab-content__title">
        <?=$partnerPage->viewData->userPhoneConfirmationMessage?>
      </h2>
      <span class="tab-content__subtitle tab-content__subtitle_viewtype_small i i_content_breakline">
        <span class="i__text"><?= __("Please confirm the phone number to use the points") ?>.</span>
      </span>
    </div>
    <div class="tab-content__body">
      <form action="{{ $partnerPage->partner->clientConfirmPhoneUrl }}" class="form form_content_auth js-ajax-form" data-ajax-callback="CONFIRM_FORM_SUCCESS"  method="post">
