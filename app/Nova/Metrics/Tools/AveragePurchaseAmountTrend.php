...
class AveragePurchaseAmountTrend extends Trend
{
    ...
    {
        return __('Average order value for all BitRewards tools');
    }
    ...
    public function calculate(Request $request): TrendResult
    {
        ...
        return $this
            ->resultWithCurrency($reportData->averageOrderValue)
            ->format('0,0[.]00');
    }

    public function uriKey(): string
    {
        return 'tools-average-purchase-amount';
    }
}
