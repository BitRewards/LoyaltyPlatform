...
class UsedPromoCodesCountValue extends Value
{
    ...
    {
        return __('Number of used promo-codes for all BitRewards tools');
    }
    ...
    public function calculate(NovaRequest $request): ValueResult
    {
        ...
        return $this
            ->result($reportData->numberOfUsedPromoCodes)
            ->format('0,0');
    }

    public function uriKey(): string
    {
        return 'tools-used-promo-codes-count';
    }
}
