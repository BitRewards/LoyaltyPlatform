...
namespace PHPSTORM_META {
    ...
    * Generated on 2018-12-10 09:51:42.
    *
    ...
    */
    override(new \Illuminate\Contracts\Container\Container(), map([
        '' => '@',
        'AMQPConnection' => \AMQPConnection::class,
        'Admitad\Api\Api' => \Admitad\Api\Api::class,
        'App\Generators\AffiliateUrlGenerator' => \App\Generators\AffiliateUrlGenerator::class,
        'App\Services\ImageStorageService\IImageStorage' => \App\Services\ImageStorageService\SelectelImageStorage::class,
        'App\Services\OAuthService' => \App\Services\OAuthService::class,
        'App\Services\ReportService' => \App\Services\ReportService::class,
        'App\Services\SentryService' => \App\Services\SentryService::class,
        'App\Services\SignatureService' => \App\Services\SignatureService::class,
        'App\Services\SmsService' => \App\Services\SmsService::class,
        'App\Services\StoreEntityService' => \App\Services\StoreEntityService::class,
        'App\Services\StoreEventService' => \App\Services\StoreEventService::class,
        'App\Services\Treasury\IApiClient' => \App\Services\Treasury\MockApiClient::class,
        'App\Services\UserService' => \App\Services\UserService::class,
        'App\Services\UsersBulkImportService' => \App\Services\UsersBulkImportService::class,
        'Fedeisas\LaravelMailCssInliner\CssInlinerPlugin' => \Fedeisas\LaravelMailCssInliner\CssInlinerPlugin::class,
        'GL\Rabbit\ApplicationProxyInterface' => \App\Rabbit\ApplicationProxy::class,
        'GL\Rabbit\ErrorHandlerInterface' => \App\Rabbit\RpcErrorHandler::class,
        'GL\Rabbit\RpcErrorHandlerInterface' => \App\Rabbit\RpcErrorHandler::class,
        ...
        'Predis\Client' => \Predis\Client::class,
        'Psr\Http\Message\ResponseInterface' => \Zend\Diactoros\Response::class,
        'Symfony\Component\Lock\Factory' => \Symfony\Component\Lock\Factory::class,
        'Symfony\Component\Lock\Store\RedisStore' => \Symfony\Component\Lock\Store\RedisStore::class,
        ...
        'command.pbag.make' => \LaravelPropertyBag\Commands\PublishSettingsConfig::class,
        'command.pbag.rules' => \LaravelPropertyBag\Commands\PublishRulesFile::class,
        ...
        'giftd.api.log' => \Monolog\Logger::class,
        ...
        'mailer' => \App\Common\Mailer::class,
        'memcached.connector' => \Illuminate\Cache\MemcachedConnector::class,
        'migration.creator' => \App\Db\CrmMigrationCreator::class,
